...
- pojojson-generate-1.2.jar  this JAR contains everyhing needed for generating POJO/JSON objects from a XML definition, A generation of objects are typically done by invoking the following command "java -cp pojojson-generate-1.2.jar JsonTransform -xml *transformation-definions*.xml"
- pojojson-1.2.jar contains the support classes for encode/decode generated POJO/JSON objects. This JAR is need when there is a need for encode/decode generated objects.
